...
PAGES = (
    ...
    PageDefinition(
        ...
        description="Manage local camera profiles without exposing credentials in the browser.",
        empty_title="No cameras configured",
        empty_description=(
            "Add-camera controls will appear when camera configuration is implemented. "
            "The application remains safe to run without a source."
        ),
        planned_milestone="M1 and M7",
    ),
    PageDefinition(
        key="models",
        label="Models",
